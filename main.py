...
parser.add_argument(
    "--total-steps", default=300000, type=int, help="number of total steps to run"
)
parser.add_argument(
    "--eval-step", default=1000, type=int, help="number of eval steps to run"
)
parser.add_argument(
    "--start-step", default=0, type=int, help="manual epoch number (useful on restarts)"
)
...
parser.add_argument(
    "--teacher-dropout", default=0, type=float, help="dropout on last dense layer"
)
parser.add_argument(
    "--student-dropout", default=0, type=float, help="dropout on last dense layer"
)
parser.add_argument(
    "--teacher_lr", default=0.01, type=float, help="train learning late"
)
parser.add_argument(
    "--student_lr", default=0.01, type=float, help="train learning late"
)
...
parser.add_argument(
    "--grad-clip", default=1e9, type=float, help="gradient norm clipping"
)
parser.add_argument("--resume", default="", type=str, help="path to checkpoint")
parser.add_argument(
    "--evaluate", action="store_true", help="only evaluate model on validation set"
)
parser.add_argument(
    "--finetune", action="store_true", help="only finetune model on labeled dataset"
)
parser.add_argument("--finetune-epochs", default=625, type=int, help="finetune epochs")
parser.add_argument(
    "--finetune-batch-size", default=512, type=int, help="finetune batch size"
)
parser.add_argument(
    "--finetune-lr", default=3e-5, type=float, help="finetune learning late"
)
parser.add_argument(
    "--finetune-weight-decay", default=0, type=float, help="finetune weight decay"
)
parser.add_argument(
    "--finetune-momentum", default=0.9, type=float, help="finetune SGD Momentum"
)
parser.add_argument(
    "--seed", default=None, type=int, help="seed for initializing training"
)
parser.add_argument(
    "--label-smoothing", default=0, type=float, help="label smoothing alpha"
)
parser.add_argument(
...
parser.add_argument(
    "--temperature", default=1, type=float, help="pseudo label temperature"
)
parser.add_argument(
    "--lambda-u", default=1, type=float, help="coefficient of unlabeled loss"
)
parser.add_argument(
    "--uda-steps", default=1, type=float, help="warmup steps of lambda-u"
)
parser.add_argument(
    "--randaug", nargs="+", type=int, help="use it like this. --randaug 2 10"
)
...
def train_loop(
    ...
    for step in range(args.start_step, args.total_steps):
        ...
        with amp.autocast(enabled=args.amp):
            ...
            weight_u = args.lambda_u * min(1.0, (step + 1) / args.uda_steps)
...
def main():
    ...
    s_scheduler = get_cosine_schedule_with_warmup(
        s_optimizer, args.warmup_steps, args.total_steps, args.student_wait_steps
    )
